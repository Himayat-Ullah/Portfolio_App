...
const Home = () => {
  ...
  // };
  return (
    <div className="caret-transparent lg:flex lg:flex-row lg:ml-40 lg:mr-40 lg:pt-20 pt-5">
      ...
      <div className="lg:rounded-[20px] rounded-[20px] lg:border lg:text-gray-100 text-gray-100 lg:w-3/4 w-auto lg:mb-10 mb-10">
        ...
        <div className="lg:ml-8 lg:mr-8 lg:select-none select-none border lg:border-0 rounded-[10px] ml-10 mr-10 pl-5 pr-5 h-full mt-5">
          ...
          <p className="lg:mb-10 ">
            I'm a proactive and detail-oriented Frontend Developer with a strong
            foundation in React.js, combined with expertise in HTML, CSS,
            JavaScript, and modern styling frameworks like Tailwind CSS. With
            hands-on experience in building and optimizing dynamic, interactive
            user interfaces, I leverage React Redux for state management and
            React Router for seamless navigation, ensuring smooth and responsive
            user experiences. <br />
            ...
            web technologies, libraries, and frameworks, continuously expanding
            my knowledge to deliver top-notch, cutting-edge solutions. <br />
            <br /> Whether collaborating with cross-functional teams or tackling
            individual projects, I bring a mix of technical expertise,
            creativity, and problem-solving skills to each task. I strive to
            make meaningful contributions to any project, pushing myself to
            improve the user experience, and adapt designs with precision and
            attention to detail.
          </p>
          <p className="lg:text-2xl text-2xl font-bold mt-5 mb-5 lg:font-bold">
            Certifications
          </p>
          <div className="lg:flex flex justify-center items-center lg:flex-wrap flex-wrap  lg:mb-10 mb-10 mt-5 lg:mt-5">
            <div>
              <div className="lg:w-52 w-52 lg:h-40 h-40 lg:ml-7 mb-5 lg:mb-5 lg:mt-5 lg:mr-3 mt-5 mr-3 flex lg:flex lg:justify-center lg:items-center justify-center items-center lg:rounded-[10px] rounded-[10px] lg:bg-slate-800 bg-slate-800">
                <FaFreeCodeCamp
                  alt="Notfound"
                  target="https://www.freecodecamp.org/certification/fccddbbbd0d-4f0f-4b0c-b079-3669ec794acc/responsive-web-design"
                  className="lg:w-32 w-32 h-32 founded-full m-auto
                lg:h-32 lg:rounded-full lg:m-auto"
                />
              </div>
              <p className="lg:w-52 lg:h-10 h-10 w-40 ml-7 m-auto text-center lg:ml-7 lg:m-auto lg:text-center">
                Responsive Web Design
              </p>
              <button className="lg:w-52 w-52 h-10 lg:h-10 lg:ml-7 lg:mt-3 mt-3 mb-3 lg:mb-3 lg:rounded rounded lg:bg-[#EA9023] bg-[#EA9023] lg:text-slate-800 text-slate-800 lg:font-semibold font-bold text-2xl lg:text-2xl">
                <a
                  href="https://www.freecodecamp.org/certification/fccddbbbd0d-4f0f-4b0c-b079-3669ec794acc/responsive-web-design"
                  target="_blank"
                >
                  Certificate Link
                </a>
            ...
            <div>
              ...
              <button className="lg:w-52 w-52 h-10 lg:h-10 lg:ml-7 lg:mt-3 lg:mb-3 mt-3 mb-3 rounded lg:rounded lg:bg-[#EA9023] bg-[#EA9023] lg:text-slate-800 text-slate-800 font-bold text-2xl lg:font-semibold lg:text-2xl">
                <a
                  href="https://www.freecodecamp.org/certification/fccddbbbd0d-4f0f-4b0c-b079-3669ec794acc/javascript-algorithms-and-data-structures"
                  target="_blank"
                >
                  Certificate Link
                </a>
